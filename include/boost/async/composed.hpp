...
#ifndef BOOST_ASYNC_COMPOSED_HPP
#define BOOST_ASYNC_COMPOSED_HPP
  ...
  auto final_suspend() noexcept
  {
    struct awaitable
    {
      ...
      std::coroutine_handle<void> await_suspend(std::coroutine_handle<composed_promise> h) noexcept
      {
        ...
        return std::coroutine_handle<void>::from_address(tmp);
      }
...
template<typename ... Args>
  requires  boost::async::detail::is_completion_handler<
...
#endif //BOOST_ASYNC_COMPOSED_HPP
